...
\begin{abstract}
In this paper we introduce  and evaluate a new actor-based library in Scala with a scalable implementation of cooperative scheduling of messages within an actor.
