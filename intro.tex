...
an object of type Callable or Runnable (depending on whether it returns a result). We show how this basic feature is integrated in the general run-time system which also caters to synchronous calls that give rise to the suspension of the entire call stack generated from a message.
